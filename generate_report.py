...
GPUS = {
    "t4-16": {"gb":16,"bw":320,"hyper":0.53,"spec":0.35,"spot":0.15,"tflops":65,"name":"T4 16 GB","vendor":"nvidia","devices":1,"form":"pcie","caps":{"fp8": False},"priceSource":{"hyper": {"provider": "aws", "sku": "g4dn.xlarge", "region": "US East (N. Virginia)", "date": "2026-09-17"}}},
    "l4-24": {"gb":24,"bw":300,"hyper":0.8,"spec":0.43,"spot":0.22,"tflops":121,"name":"L4 24 GB","vendor":"nvidia","devices":1,"form":"pcie","caps":{"fp8": True},"priceSource":{"hyper": {"provider": "aws", "sku": "g6.xlarge", "region": "US East (N. Virginia)", "date": "2026-09-17"}}},
    ...
    "a100-40": {"gb":40,"bw":1555,"hyper":3.4,"spec":1.29,"spot":0.63,"tflops":312,"name":"A100 40 GB","vendor":"nvidia","devices":1,"form":"sxm","caps":{"fp8": False},"default":True,"priceSource":{"hyper": {"provider": "azure", "sku": "Standard_ND96asr_A100_v4", "region": "eastus", "date": "2026-09-17"}}},
    ...
    "l40s-48": {"gb":48,"bw":864,"hyper":1.86,"spec":1.3,"spot":0.9,"tflops":362,"name":"L40S 48 GB","vendor":"nvidia","devices":1,"form":"pcie","caps":{"fp8": True},"priceSource":{"hyper": {"provider": "aws", "sku": "g6e.xlarge", "region": "US East (N. Virginia)", "date": "2026-09-17"}}},
    "a100-80": {"gb":80,"bw":2039,"hyper":4.1,"spec":1.79,"spot":0.99,"tflops":312,"name":"A100 80 GB","vendor":"nvidia","devices":1,"form":"sxm","caps":{"fp8": False},"priceSource":{"hyper": {"provider": "azure", "sku": "Standard_ND96amsr_A100_v4", "region": "eastus", "date": "2026-09-17"}}},
    "h100-80": {"gb":80,"bw":3352,"hyper":12.3,"spec":3.99,"spot":3.02,"tflops":990,"name":"H100 80 GB","vendor":"nvidia","devices":1,"form":"sxm","caps":{"fp8": True},"priceSource":{"hyper": {"provider": "azure", "sku": "Standard_ND96isr_H100_v5", "region": "eastus", "date": "2026-09-17"}, "spec": {"provider": "lambda", "sku": "NVIDIA H100 SXM (80 GB, 208 vCPU tier)", "region": "global", "date": "2026-09-17"}, "spot": {"provider": "vast", "sku": "H100 SXM (median of 6 verified offers)", "region": "global", "date": "2026-09-17"}}},
    "rtxpro-96": {"gb":96,"bw":1792,"hyper":5.0,"spec":2.5,"spot":2.0,"tflops":504,"name":"RTX PRO 6000 96 GB","vendor":"nvidia","devices":1,"form":"pcie","caps":{"fp8": True},"priceSource":{"spec": {"provider": "coreweave", "sku": "NVIDIA RTX PRO 6000 Blackwell Server Edition (High Memory)", "region": "global", "date": "2026-09-17"}}},
    "h200-141": {"gb":141,"bw":4800,"hyper":7.91,"spec":3.99,"spot":2.5,"tflops":990,"name":"H200 141 GB","vendor":"nvidia","devices":1,"form":"sxm","caps":{"fp8": True},"priceSource":{"hyper": {"provider": "aws", "sku": "p5en.48xlarge", "region": "US East (N. Virginia)", "date": "2026-09-17"}}},
    "b200-192": {"gb":192,"bw":8000,"hyper":14.24,"spec":6.69,"spot":2.12,"tflops":2250,"name":"B200 192 GB","vendor":"nvidia","devices":1,"form":"sxm","caps":{"fp8": True},"priceSource":{"hyper": {"provider": "aws", "sku": "p6-b200.48xlarge", "region": "US East (N. Virginia)", "date": "2026-09-17"}, "spec": {"provider": "lambda", "sku": "NVIDIA B200 SXM6 (180 GB, 208 vCPU tier)", "region": "global", "date": "2026-09-17"}}},
}
# GPU_TABLE:END
