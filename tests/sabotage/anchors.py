...
GPUS_ADA_ROW = ("\"rtx6000ada-48\": { \"gb\": 48, \"bw\": 960, \"hyper\": 1.5, \"spec\": 0.9, \"spot\": 0.6, \"tflops\": 364, \""
                "name\": \"RTX 6000 Ada 48 GB\", \"vendor\": \"nvidia\", \"perfKey\": \"nvidia\", \"devices\": 1, \"form\": \"pci"
                "e\", \"caps\": { \"fp8\": true }, \"priceNote\": { \"hyper\": { \"reason\": \"In the catalog since 2026-07-2"
                "7 as a mid-2026 list price, with no provider recorded.\", \"checked\": \"2026-09-23\" }, \"spec\": { \"r"
                "eason\": \"In the catalog since 2026-07-27 as a mid-2026 list price, with no provider recorded. La"
                "mbda's and CoreWeave's A6000 is the older Ampere RTX A6000, not this card.\", \"checked\": \"2026-09"
                "-16\" }, \"spot\": { \"reason\": \"In the catalog since 2026-07-27 as a mid-2026 list price, with no p"
                "rovider recorded. The weekly check can read Vast.ai, but its name for the RTX 6000 Ada hasn't be"
                "en confirmed against a live query yet.\", \"checked\": \"2026-09-23\" } } }")
